...
def test_main
  test_url = "http://always-eating.blogspot.com/2009/05/legit-marathon-meal-at-veritas.html"
...
def main
  log_file=File.open("alwayseating.log","a+")
...
blogparser_pipeline(Alwayseating)
