...
dlmwrite('output/withexistingvote_train_tprs_fprs_accs.txt',train);
dlmwrite('output/withexistingvote_test_tprs_fprs_accs.txt',test);
T = [train_preds,train_ys];
TT = sortrows(T,1);
dlmwrite('output/withexistingvote_train_predtrue_sorted.txt',TT);
TT = sortrows([test_preds,test_ys],1);
dlmwrite('output/withexistingvote_test_predtrue_sorted.txt',TT);
